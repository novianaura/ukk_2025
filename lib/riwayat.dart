...
class _TransaksiPageState extends State<TransaksiPage> {
  ...
  double _calculateTotal() {
    return transaksiList.fold(0, (total, product) {
  ...
  void _masukkanKePenjualan() {
    if (selectedCustomer == null) {
      ...
      setState(() {
        riwayatTransaksi.addAll(transaksiList);
        transaksiList.clear();
      });
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => RiwayatPage(transaksiItems: riwayatTransaksi),
        ),
      );
    }
  }
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: _masukkanKePenjualan,
                      child: Text('Masukkan ke Penjualan'),
                    ),
                  ],
                ),
